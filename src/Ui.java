...
public class Ui {
	...
	public GLabel gunLabel = new GLabel("");
	
	public void addImages(Game main, int app_width, int app_height){
		main.add(this.heart1); this.heart1.setLocation(app_width - heart1.getWidth() * 1, 0);
		main.add(this.heart2); this.heart2.setLocation(app_width - heart1.getWidth() * 2, 0);
